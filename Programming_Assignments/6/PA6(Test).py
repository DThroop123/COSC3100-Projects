...
# method that hashes a given integer into the filter, this must be edited (!)
# this will return five values using five hash functions
def hasher5(ix):
...
class Bloom:
	...
	# TESTED CONNECTION (seems to be working)
	def look_up(self, x):
